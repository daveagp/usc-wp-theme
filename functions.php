...
require_once("websheets-adaptor.php");
require_once("codedrop-adaptor.php"); // note, this depends on websheets.js because of auth
require_once("visualize-adaptor.php");
